...
Original file is located at
    https://colab.research.google.com/drive/1wsCsgX81MqUoKMcMAMFamjjYRd3zOHZR
"""
...
df = pd.read_table('/content/drive/MyDrive/MiddlePhalanxOutlineCorrect_TRAIN.tsv', header=None, encoding='latin-1')
df_test = pd.read_table('/content/drive/MyDrive/MiddlePhalanxOutlineCorrect_TEST.tsv', header=None, encoding='latin-1')
...
len(X_train), len(X_test), len(X_train[0][0])
...
def generate_alstmfcn(NUM_CELLS=128):
    ...
    ip = Input(shape=(1, len(X_train[0][0])))
    ...
    out = Dense(2, activation='softmax')(ko)
...
score=model.evaluate(X_test[180:],y_test[180:], batch_size=32)
...
model.save("cce_adam_alstm_D3")

model.save_weights("model_cce_adam_alstm_D3.h5")

import shutil
shutil.make_archive('/content/cce_adam_alstm_D3', 'zip', '/content/cce_adam_alstm_D3')
